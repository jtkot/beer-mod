...
public class ModItems {
	...
	public static final Item FULL_BEER_MUG = registerItem("full_beer_mug", new Item.Properties().food(
			new FoodProperties(1, 0.6f, true), Consumable.builder()
					...
					.onConsume(new ApplyStatusEffectsConsumeEffect(new MobEffectInstance(MobEffects.NAUSEA, 250),
							10000.0f))
					.build())
