...
public class Items {
  ...
  private static Item register(
    ...
    return Registerer.registerItem(Mod.NAMESPACE.createItemKey(name), tab, constructor, properties);
  }

  private static Item register(
      String name, ResourceKey<CreativeModeTab> tab, Item.Properties properties) {
    return register(name, tab, Item::new, properties);
  }

  private static Item register(
      String name, ResourceKey<CreativeModeTab> tab, Function<Item.Properties, Item> constructor) {
